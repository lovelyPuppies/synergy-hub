...
bool calculation(bot3_kccistc_service::bot3gpio::Request &req,
                 bot3_kccistc_service::bot3gpio::Response &res)
{
...
int main(int argc, char **argv)              // Node Main Function
{
  ...
  ros::ServiceServer kccistc_service_server = nh.advertiseService("bot3_gpio", calculation);
