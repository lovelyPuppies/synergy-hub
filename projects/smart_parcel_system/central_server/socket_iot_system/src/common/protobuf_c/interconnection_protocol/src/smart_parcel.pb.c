...
#include "interconnection_protocol/src/smart_parcel.pb.h"
...
PB_BIND(smart_parcel_NodeEvent, smart_parcel_NodeEvent, 2)
...
PB_BIND(smart_parcel_ParcelArrivalEvent, smart_parcel_ParcelArrivalEvent, AUTO)
