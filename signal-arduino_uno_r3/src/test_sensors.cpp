// // wifi_lcd_cds_servo_detach_dht11_clock_pwm_dcmotor.ino
// /*
...
//   sprintf(lcdLine2, "%d.%d.%d.%d", WiFi.localIP()[0], WiFi.localIP()[1],
...
//       client.flush();
//     }
//     sprintf(lcdLine1, "%02d.%02d  %02d:%02d:%02d", dateTime.month, dateTime.day,
