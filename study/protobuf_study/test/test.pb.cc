...
const ::uint32_t
    TableStruct_test_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        PROTOBUF_FIELD_OFFSET(::test::Test, _impl_._has_bits_),
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::test::Test, _impl_.id_),
...
const char descriptor_table_protodef_test_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "\n\004name\030\002 \001(\tb\010editionsp\350\007"
};
...
inline PROTOBUF_NDEBUG_INLINE Test::Impl_::Impl_(
    ...
    const Impl_& from, const ::test::Test& from_msg)
...
const ::_pbi::TcParseTable<1, 2, 0, 22, 2> Test::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::test::Test>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // string name = 2;
    {::_pbi::TcParser::FastUS1,
     {18, 0, 0, PROTOBUF_FIELD_OFFSET(Test, _impl_.name_)}},
    // int32 id = 1;
        ...
        ::uint8_t* Test::_InternalSerialize(
          ...
          if (cached_has_bits & 0x00000001u) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "test.Test.name");
