...
#define IOCTLTEST_LEDOFF     _IO(IOCTLTEST_MAGIC, 5)
#define IOCTLTEST_KEYLEDFREE _IO(IOCTLTEST_MAGIC, 6)
#define IOCTLTEST_READ       _IOR(IOCTLTEST_MAGIC, 7, ioctl_test_info)
#define IOCTLTEST_WRITE      _IOW(IOCTLTEST_MAGIC, 8, ioctl_test_info)
#define IOCTLTEST_WRITE_READ _IOWR(IOCTLTEST_MAGIC, 9, ioctl_test_info)
